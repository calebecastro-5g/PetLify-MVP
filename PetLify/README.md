...
- arquivo para abrir localmente com dois cliques no Windows.
...
## Como abrir localmente no Windows
...
- preparar o banco demo;
- instalar dependências do frontend;
- abrir o backend;
- abrir o frontend;
- abrir o navegador em `http://localhost:3000`.

Deixe as janelas de terminal abertas enquanto estiver usando o sistema.
...
Esta versão está preparada para subir como um único Web Service no Render.
