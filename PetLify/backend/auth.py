...
def password_is_valid(password: str) -> bool:
    # Regra simplificada para o MVP: permite senhas iniciais cadastradas pelo dono
    # sem bloquear o fluxo de QA e demonstração. As senhas continuam com Bcrypt.
...
def login():
    ...
    if requires_2fa:
        ...
        # MVP: como ainda não há serviço real de e-mail, o código é exibido na tela para permitir QA.
        response = {
            'requires_2fa': True,
            'message': 'Código de verificação gerado para o MVP.',
            'dev_2fa_code': code,
        }
